...
router.post('/create_array', function (req, res, next) {
    ...
    var getLineReactorId = function (lineReactorIterator, callback) {
        ...
        LineReactor.getWithCreation(lineReactors[lineReactorIterator]["name"], lineReactors[lineReactorIterator]["description"], lineReactors[lineReactorIterator]["sil"], lineReactors[lineReactorIterator]["stability_limit"], lineReactors[lineReactorIterator]["thermal_limit"], lineReactors[lineReactorIterator]["elem_num"], lineReactors[lineReactorIterator]["ownerName"].split('/'), lineReactors[lineReactorIterator]["region"].split('/'), lineReactors[lineReactorIterator]["state"].split('/'), lineReactors[lineReactorIterator]["substation_names"], lineReactors[lineReactorIterator]["substation_voltages"], lineReactors[lineReactorIterator]["line_name"], lineReactors[lineReactorIterator]["voltage"], lineReactors[lineReactorIterator]["line_elem_num"], lineReactors[lineReactorIterator]["mvar"], lineReactors[lineReactorIterator]["is_switchable"], function (err, rows) {
            if (err) {
                console.log(err);
                return callback(err);
            }
